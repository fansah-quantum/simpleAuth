...
from api.v1.router import user, health
from config.setting import AuthSettings
 
from core  import setup as db_setup # type: ignore
...
class AppBuilder:
    ...
    def register_exceptions(self):
        ...
        self._app.add_exception_handler(
            InternalProcessingError, exec.validation_exception_handler  # type: ignore
        )
        self._app.add_exception_handler(
            ServiceError, exec.validation_exception_handler  # type: ignore
        )
